...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"index/interface/dashboard/remove-project"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
			...
			<Section background="--color-white" padding="24px 0 64px 0">
				...
				<Components.HelpGroup>
					<Components.HelpImageBlockCapture>
						<Override slot="helpImageBlock" src="https://test-upl.quarkly.io/607d3473b99fb9001fcbcc16/images/docs-new-dashboard-delete-project.png?v=2021-05-15T08:07:10.021Z" />
						<Override slot="text">
							Пункт "Delete" в контекстном меню проекта
						</Override>
					</Components.HelpImageBlockCapture>
