...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"index/interface/work-area/project-settings/general"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		<Box display="flex" quarkly-title="Content">
			...
			<Section background="--color-white" padding="24px 0 64px 0">
				...
				<Components.HelpPrevNextButton hierarchy="several">
					<Override slot="Button Link :-index-interface-work-area-project-settings-project-settings">
						Project Settings
					</Override>
